// grafica-lagrange.js
let lagrangeChartInstance = null; // guardamos la instancia del chart para actualizarla
...
function dibujarGraficaLagrange(xs, ys, polinomio, xEval = null) {
    const canvas = document.getElementById('lagrangeChart');
    if (!canvas) return;
    ...
    // Si ya existe un chart, lo destruimos
    ...
    lagrangeChartInstance = new Chart(canvas, {
      type: 'line',
      data: {
        labels: curvaX,
        datasets: [
